...
def error(f,x,y):
    ...
    # переделано с использованием функции из scikit-learn
...
f5 = np.poly1d(f5p)
print("Параметры модели 4 (степень полинома 5) {}".format(f5p))
...
f10 = np.poly1d(f10p)
print("Параметры модели 5 (степень полинома 10) {}".format(f10p))
...
f20 = np.poly1d(f20p)
print("Параметры модели 6 (степень полинома 20) {}".format(f20p))
...
print('Степень полинома 1')
print(f"MSE (только для данных до 3.5 недели) = {error(f1, hours_data_1, requests_data_1):.5}")
print(f"MSE (для данных с 3.5 недели по 4.1 недели) = {error(f1, hours_data_2, requests_data_2):.5}")

print('Степень полинома 2')
print(f"MSE (только ля данных до 3.5 недели) = {error(f2, hours_data_1, requests_data_1):.5}")
print(f"MSE (для данных с 3.5 недели по 4.1 недели) = {error(f2, hours_data_2, requests_data_2):.5}")

print('Степень полинома 3')
print(f"MSE (только для данных до 3.5 недели) = {error(f3, hours_data_1, requests_data_1):.5}")
print(f"MSE (для данных с 3.5 недели по 4.1 недели) = {error(f3, hours_data_2, requests_data_2):.5}")

print('Степень полинома 5')
print(f"MSE (только для данных до 3.5 недели) = {error(f5, hours_data_1, requests_data_1):.5}")
print(f"MSE (для данных с 3.5 недели по 4.1 недели) = {error(f5, hours_data_2, requests_data_2):.5}")

print('Степень полинома 10')
print(f"MSE (только для данных до 3.5 недели) = {error(f10, hours_data_1, requests_data_1):.5}")
print(f"MSE (для данных с 3.5 недели по 4.1 недели) = {error(f10, hours_data_2, requests_data_2):.5}")

print('Степень полинома 20')
print(f"MSE (только для данных до 3.5 недели) = {error(f20, hours_data_1, requests_data_1):.5}")
print(f"MSE (для данных с 3.5 недели по 4.1 недели) = {error(f20, hours_data_2, requests_data_2):.5}")

"""Наименьшую ошибку для обоих частей (до 3.5 недели и с 3.5 недели по 4.1 недели) даёт модель с степенью полинома = 5 и степенью полинома = 10."""